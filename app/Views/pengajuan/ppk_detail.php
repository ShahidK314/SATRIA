<?php 
// app/Views/pengajuan/ppk_detail.php (RESPONSIVE)
...
<div class="m-4 md:m-5">
    <div class="mb-6 md:mb-8">
        <a href="/pengajuan/ppk" class="text-slate-500 hover:text-blue-600 font-bold flex items-center gap-2 mb-4 transition-colors w-fit">
        ...
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-slate-500 mt-1 text-sm md:text-base">Verifikasi kelengkapan administrasi dan substansi sebelum persetujuan.</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="text-[10px] font-bold text-slate-400 uppercase">Pengusul (Unit)</label>
                            <div class="text-slate-700 mt-1 font-medium bg-slate-50 px-3 py-2 rounded-lg border border-slate-100"><?php echo htmlspecialchars($usulan['username']); ?> (<?php echo htmlspecialchars($usulan['nama_jurusan']); ?>)</div>
                        </div>
                        <div>
                            <label class="text-[10px] font-bold text-slate-400 uppercase">Penanggung Jawab</label>
                            <div class="text-slate-700 mt-1 font-medium bg-slate-50 px-3 py-2 rounded-lg border border-slate-100"><?php echo htmlspecialchars($pengajuan['penanggung_jawab']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-6">
                <h3 class="text-lg md:text-xl font-bold text-slate-800 mb-4 flex items-center justify-between border-b pb-3">
                    <div class="flex items-center">
                         <span class="material-icons text-blue-600 mr-2">assignment</span> Kerangka Acuan Kegiatan
                    </div>
                ...
                <div class="space-y-4 md:space-y-6 text-sm">
                    <div class="border-b border-slate-100 pb-4">
                        <label class="text-[10px] font-bold text-slate-400 uppercase">Kurun Waktu Pelaksanaan</label>
                        <p class="text-slate-800 mt-1 font-bold text-base"><?php echo date('d M Y', strtotime($pengajuan['tanggal_mulai'])); ?> s/d <?php echo date('d M Y', strtotime($pengajuan['tanggal_selesai'])); ?></p>
                    </div>
                    <div class="border-b border-slate-100 pb-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 border-b border-slate-100 pb-4">
                        <div>
                            ...
                            <ul class="list-disc list-inside text-slate-700 mt-1 pl-2 md:pl-4 bg-slate-50 border border-slate-100 p-3 rounded-lg">
                        ...
                        <div>
                            ...
                            <ul class="list-decimal list-inside text-slate-700 mt-1 pl-2 md:pl-4 bg-slate-50 border border-slate-100 p-3 rounded-lg">
                            ...
                            <table class="w-full text-xs border border-slate-200 min-w-[500px]">
                                <thead class="bg-slate-50">
                                    <tr>
                                        ...
                                        <th class="p-3 border border-slate-200 text-center w-24">Target Bulan</th>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-6">
                ...
                <div class="overflow-x-auto w-full custom-scrollbar pb-2">
                    <table class="w-full text-sm border border-slate-200 min-w-[500px]">
                        <thead class="bg-slate-50">
                            <tr>
                                <th class="p-3 border border-slate-200 w-3/4 text-left">Deskripsi IKU</th>
                                <th class="p-3 border border-slate-200 text-center w-1/4">Target</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-100">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-6">
                <h3 class="text-lg md:text-xl font-bold text-slate-800 mb-4 flex items-center justify-between">
                    <div class="flex items-center">
                        <span class="material-icons text-amber-600 mr-2">payments</span> Rincian Anggaran (RAB)
                    </div>
                </h3>
                
                <div class="overflow-x-auto w-full custom-scrollbar pb-2">
                    <table class="w-full text-sm min-w-[900px]">
                        <thead class="bg-slate-50 text-slate-500 uppercase font-bold text-[10px] border border-slate-200">
                            <tr>
                ...
                <div class="mt-4 flex justify-end">
                    <a href="/pdf/rab?id=<?php echo $pengajuan['usulan_id']; ?>" target="_blank" class="text-xs px-4 py-2 bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-lg font-bold flex items-center transition-colors">
                        <span class="material-icons text-[14px] mr-1">print</span> Cetak RAB Lengkap
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-6">
                ...
                <a href="<?php echo htmlspecialchars($pengajuan['surat_pengantar_path']); ?>" target="_blank" 
                   class="flex flex-col sm:flex-row items-center sm:items-start gap-4 p-4 border border-slate-200 rounded-xl hover:border-blue-400 hover:bg-blue-50 hover:shadow-sm transition-all group">
                    <div class="w-14 h-14 rounded-full bg-rose-100 text-rose-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-inner">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-blue-200 overflow-hidden sticky top-6 z-10">
                <div class="bg-blue-600 px-6 py-4">
                    <h3 class="text-lg font-bold text-white flex items-center">
                        <span class="material-icons mr-2">verified_user</span> Keputusan PPK
                    </h3>
                </div>

                <form action="/pengajuan/ppk/aksi?id=<?php echo $pengajuan['id']; ?>" method="POST" class="p-4 md:p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="rekomendasi" rows="4" 
                                  ...
                                  placeholder="Tuliskan catatan rekomendasi untuk WD2 atau Bendahara di sini..."></textarea>
                    </div>
                    ...
                    <div class="space-y-3 pt-4 border-t border-slate-100">
                        <button type="submit" name="aksi" value="setuju" 
                                ...
                                onclick="return confirm('Yakin menyetujui pengajuan kegiatan ini? Data akan diteruskan ke WD2.')">
