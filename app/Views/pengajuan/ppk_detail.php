<?php 
// app/Views/pengajuan/ppk_detail.php
...
<div class="p-8 max-w-6xl mx-auto">
    <div class="mb-8">
        <a href="/pengajuan/ppk" class="text-slate-500 hover:text-blue-600 font-bold flex items-center gap-2 mb-4 transition-colors">
        ...
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-slate-500 mt-1">Verifikasi kelengkapan administrasi dan substansi sebelum persetujuan.</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-lg border border-blue-200 overflow-hidden sticky top-6">
                ...
                <form action="/pengajuan/ppk/aksi?id=<?php echo $pengajuan['id']; ?>" method="POST" class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="rekomendasi" rows="4" 
                                  ...
                                  placeholder="Catatan untuk WD2 atau Bendahara..."></textarea>
                    </div>

                    <div class="space-y-3 pt-2 border-t border-slate-100">
                        <button type="submit" name="aksi" value="setuju" 
                                class="w-full py-3.5 bg-blue-600 text-white font-bold rounded-xl shadow-lg hover:bg-blue-700 transition-all flex justify-center items-center"
                                onclick="return confirm('Yakin menyetujui pengajuan kegiatan ini? Akan diteruskan ke WD2.')">
                            <span class="material-icons text-sm mr-2">check_circle</span>
                            Setujui & Teruskan ke WD2
                        </button>
                    </div>
                </form>
            </div>
