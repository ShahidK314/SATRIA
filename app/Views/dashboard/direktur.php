...
<div class="m-5">
    <div class="mb-8">
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Dashboard Direktur</h1>
        <p class="text-slate-500 mt-1">Selamat datang, Direktur. Ringkasan Kinerja dan Pengawasan Sistem.</p>
    </div>
    ...
    <?php if(!empty($proposerStats)): 
        ...
        foreach($proposerStats as $index => $p) {
            $labels[] = $p['username'];
            $dataTotal[] = $p['total_usulan'];
            $dataBerlangsung[] = $p['total_berlangsung'];
            $dataSelesai[] = $p['total_selesai'];
            ...
            options: {
                ...
                plugins: {
                    ...
                    datalabels: {
                        ...
                        color: '#555',
                        font: { weight: 'bold' },
                        formatter: Math.round // Tampilkan angka di kanan
                    }
                }
            }
        });
