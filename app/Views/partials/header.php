...
elseif (strpos($uri, '/approval') !== false || strpos($uri, '/pengajuan/ppk') !== false || strpos($uri, '/pengajuan/wd2') !== false) $pageTitle = 'Persetujuan (Approval)';
...
elseif (strpos($uri, '/pencairan') !== false) $pageTitle = 'Pencairan Dana';
elseif (strpos($uri, '/lpj') !== false) $pageTitle = 'Verifikasi LPJ';
?>
<!DOCTYPE html>
<html lang="id">
<head>
