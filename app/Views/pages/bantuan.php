...
<div class="m-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center place-items-center">
        <a href="#" class="group bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-blue-400 hover:shadow-lg transition-all text-center w-full max-w-xs">
            ...
            <p class="text-xs text-slate-400 mb-4">PDF • Updated 2025</p>
            <span class="text-blue-600 text-sm font-bold group-hover:underline">Download File</span>
        </a>

        <!-- CARD 2 -->
        <a href="#" class="group bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-amber-400 hover:shadow-lg transition-all text-center w-full max-w-xs">
            ...
            <h3 class="font-bold text-slate-800 mb-1">User Manual</h3>
