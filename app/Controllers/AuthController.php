<?php
// app/Controllers/AuthController.php (FINALIZED)
...
class AuthController
{
    ...
    // Menangani Flash Message dari Session
    ...
    public function login()
    {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            // Login Gagal: Gunakan Session Flash & Redirect
    ...
    private function logAudit($userId, $aksi)
    {
       ...
       // Kolom aksi, user_id, ip_address sesuai dengan log_audit_sistem
